#!/usr/bin/python3
"""
This module contains the TestAmenityDocs classes for testing the Amenity class.
It includes tests for PEP8 conformance, module and class docstrings,
and the presence of docstrings in Amenity methods.
"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test that Amenity has an attribute name, and it's an empty string."""
        amenity = Amenity()
